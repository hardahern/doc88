...
def get_request(url: str, timeout: float = 30):
    headers = {
...
def download(url: str, filepath: str, timeout: float = 60):
    write_file(requests.get(url, timeout=timeout).content, filepath)
